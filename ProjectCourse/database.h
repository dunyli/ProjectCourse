...
namespace ProjectCourse {
	...
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_data;
	...
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_output_supplier;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_output_client;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_output_product;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_product;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_supplier;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_client;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_order;
	public: System::Windows::Forms::ToolStripMenuItem^ ToolStripMenuItem_edit_service;
...
private: System::Void ToolStripMenuItem_delete_client_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (dialog == System::Windows::Forms::DialogResult::No)
		...
		for (int i = 0; i < dataGridView_clients->Rows->Count; i++) {
			/*Удаляем строки*/
			dataGridView_clients->Rows->RemoveAt(i);
			i--;
		}
		/*Удаляем файл*/
		StreamWriter^ new_file = gcnew StreamWriter("client.txt");
...
//Удаление базы товаров
private: System::Void ToolStripMenuItem_delete_product_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Windows::Forms::DialogResult dialog = MessageBox::Show("Файл с данными клиентов будет удален, восстановить данные будет невозможно.\nВы уверены?", "Предупреждение", MessageBoxButtons::YesNo, MessageBoxIcon::Question);
	if (dialog == System::Windows::Forms::DialogResult::No)
		return;
	else {
		for (int i = 0; i < dataGridView_product->Rows->Count; i++) {
			/*Удаляем строки*/
			dataGridView_product->Rows->RemoveAt(i);
			i--;
		}
		/*Удаляем файл*/
		StreamWriter^ new_file = gcnew StreamWriter("products.txt");
